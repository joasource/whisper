...
print("joaquina.py Script de fast-whisper (para uso com GPU NVIDIA - CUDA e cuDNN) para transcrição de áudios em diretórios, ZIPs e UFDR por Joaquim Ferreira.")
